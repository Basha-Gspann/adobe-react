        ...
        return (
           ...
           <div class="aem-Grid aem-Grid--12 new">
            ...
            <div class="aem-GridColumn aem-GridColumn--default--6 aem-GridColumn--phone--12">
                  ...
                  <BsStarFill size={18}/>
                  <BsStarFill size={18}/>
                  <BsStar size={18}/><strong>(175)</strong>
                  <p className='desc'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor labore et dolore magna. <a href=''>Read more</a>
                  </p>
                  <hr></hr>

                    <div className="product-colors">
                    <h5>Color</h5>
                    <img src={Colorone} className="colorone" alt="Colorone" />
                    <img src={Colortwo} className="colortwo" alt="Colortwo" />
                    <img
                      src={Colorthree}
                  ...
                  <h5>Quantity</h5>
                    ...
                    >ADD TO CART</button>
                    <div className='save'>
                       <a href="#">< AiOutlineHeart size={25}/> &nbsp;save</a>&nbsp;&nbsp;&nbsp;&nbsp;
                       <a href="#"><BiShareAlt size={25}/>&nbsp;share</a>
                ...
                <h1>{product.title}</h1>
                    ...
                    <div class="aem-GridColumn aem-GridColumn--default--3 aem-GridColumn--phone--12">
                        ...
                        <h5>&nbsp;</h5>
                            ...
                            <h6 className='detailstwo'>< TbLeaf size={22}/>&nbsp;&nbsp;&nbsp;69% nylon, 31% lycra</h6>
                        </div>
                    </div>
                </div>
                <hr />
